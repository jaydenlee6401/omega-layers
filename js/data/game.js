var game = {
    ...
    achievements: [
        ...
        new Achievement("Nine Lives", "Have 1 <span>α<sub>9</sub></span> Generator", "<span>α<sub>9</sub></span>", () => game.layers[0] && game.layers[0].generators[8].bought.gt(0)),
        new Achievement("Ten is the best", "Have 1 <span>α<sub>10</sub></span> Generator", "<span>α<sub>10</sub></span>", () => game.layers[0] && game.layers[0].generators[9].bought.gt(0)),
